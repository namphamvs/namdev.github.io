...
(function() {
  function NamPhamProtect() {
    ...
    var NamPhamContent = "-NamPham-";
    var NamPham = document.getElementById("Telegram_@NamPham");
    if (NamPham === null) {
      alert('Phát hiện source code đã bị chỉnh sửa - error 0x000001 !!!')
      window.location.replace("//www.facebook.com/WusNamDev");
      return;
    } else if (NamPham.innerHTML !== NamPhamContent){
      return;
    }
  }
  NamPhamProtect();
...
// ABOUT ME
document.getElementById("NamPhamAbout_1").innerHTML = 'Nam Phạm Dev sinh ra và lớn lên tại Kim Sơn Ninh Bình và hiện tại đang học ở trường THPT Kim Sơn B .';
// FOOTER
const footerElement = document.createElement("footer");
footerElement.classList.add("Cuoi", "Trang");
const pElement = document.createElement("p");
pElement.classList.add("NamPhamFtCopyright");
const spanElement = document.createElement("span");
spanElement.style.fontFamily = "Monomaniac One";
spanElement.classList.add("copyright");
const aElement = document.createElement("a");
aElement.style.textDecoration = "none";
aElement.href = "https://www.facebook.com/profile.php?id=100083125762418";
...
.MangXaHoiFtNamPham:after {
  content: "";
  clear: both;
  display: table;
}
.MangXaHoiFtNamPham div:not(:last-child) {
  border-right: none; 
}
.MangXaHoiFtNamPham div:hover {
...
let typed = new Typed(".GioiThieu", {
  strings: ["Hi my name is Nam Phạm","Hey brother, I'm a Developer.", "I like website design :))"],
  typeSpeed: 95,
  backSpeed: 75,
  loop: true
})
